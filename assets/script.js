...
const lowerWords = ["Air", "Airplane", "Appliance", "Apple", "Basement", "Bathtub", "Bed", "Book", "Brush", "Cabinet", "Car", "Chair", "City", "Classroom", "Clock", "Coffee", "Computer", "Cup", "Curtain", "Desk", "Dog", "Dolphin", "Door", "Drawer", "Do", "Earthquake", "Elevator", "Elephant", "Faucet", "Family", "Floor", "Flower", "Fork", "Food", "Four", "Friend", "Glass", "Hat", "Heart", "House", "Key", "Lamp", "Lemon", "Light", "Lime", "Mirror", "Movie", "Music", "Ocean", "Paper", "Pen", "Pear", "Phone", "Pineapple", "Plate", "Pot", "River", "Rug", "School", "Scissors", "Shelf", "Shirt", "Shoe", "Sink", "Soap", "Sock", "Six", "Spoon", "Suitcase", "Sun", "Table", "Telephone", "Three", "Time", "Toothbrush", "Train", "Vase", "Window"]
const special = ["?", "!", "@", "#", "$", "%", "&", "*"]
